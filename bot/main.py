...
def register_all_handlers(dp: Dispatcher, bot: Bot):
    ...
    async def legal_terms(callback: types.CallbackQuery):
        text = (
            ...
            "**2. Термины**\n"
            "• **Исполнитель** — Самозанятый Задов Иван Владимирович, "
            "ИНН 519047822108\n"
            "• **Заказчик** — дееспособное лицо, использующее Сервис\n"
            "• **Услуга** — информационно-консультационные услуги\n\n"
            "**3. Предмет Договора**\n"
            ...
            "**4. Описание услуг**\n"
            "• 🔍 Анализ симптомов — разбор жалоб\n"
            "• 🔬 Расшифровка анализов — пояснение показателей\n"
            "• ✍️ Распознавание почерка — расшифровка текста\n\n"
            "**5. Заказ и оказание услуг**\n"
            "• Отправить команду /start → выбрать тип услуги\n"
            "• Предоставить данные (текст или фото)\n"
            "• При необходимости оплатить\n"
            "• Результат — в чате с ботом в течение нескольких минут\n\n"
            "**6. Цены**\n"
            "• 1 запрос — 50 ₽\n"
            "• 2 запроса — 99 ₽\n"
            "• 10 запросов — 199 ₽\n"
            "• Возможна оплата Telegram Stars или Robokassa\n\n"
            "**7. Возврат средств**\n"
            "• До начала оказания услуги — отказ в любое время\n"
            "• После оплаты — при техническом сбое или ошибке Сервиса\n"
            "• Алгоритм: письмо на vudd049@gmail.com с темой "
            "«Возврат средств — МедАссистент»\n"
            "• Ответ — 5 рабочих дней, возврат — до 10 рабочих дней\n"
            "• Возврат в полной сумме, без удержания комиссий\n\n"
            "**8. Конфиденциальность**\n"
            "• Данные защищаются по ФЗ №152 и №149\n\n"
            "**9. Ответственность**\n"
            "• Результаты не являются медицинским диагнозом\n"
            "• Ответственность ограничена стоимостью услуги\n\n"
            "**10. Реквизиты Исполнителя**\n"
            "📌 Самозанятый Задов Иван Владимирович\n"
            "📌 ИНН: 519047822108\n"
            "📞 +7 917 268-89-34\n"
            "📧 vudd049@gmail.com\n\n"
            "---\n"
    ...
    async def legal_privacy(callback: types.CallbackQuery):
        text = (
            ...
            "Самозанятый Задов Иван Владимирович, ИНН 519047822108\n"
            ...
            "• Данные об оплате — обработка платежей\n\n"
            "**3. Цель обработки**\n"
            "Предоставление информационно-справочных материалов, "
            "обработка платежей, улучшение Сервиса.\n\n"
            "**4. Правовое основание**\n"
            "Ст. 6 и ст. 10 ФЗ №152 «О персональных данных».\n\n"
            "**5. Хранение данных**\n"
            "• На территории РФ\n"
    ...
    async def legal_support(callback: types.CallbackQuery):
        text = (
            ...
            "**Исполнитель:** Задов Иван Владимирович\n"
            "**Статус:** Самозанятый\n"
            "**ИНН:** 519047822108\n\n"
